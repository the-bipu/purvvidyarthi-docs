                ...
                <div className="space-y-8">
                    ...
                    {activeSection === 'getting-started' && (
                        <div className="mt-12 pt-8 border-t border-gray-200">
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Jira is an industry-leading project management tool that brings every team together to plan, track,
                                and deliver any type of project with confidence. It is the single source of truth for your entire
                                organization, empowering teams with the context to move quickly while staying connected to the
                                greater business goal. Whether used to manage everyday tasks or scale complex projects, Jira is
                                flexible enough to support any team's workflow.
                            </p>
                        </div>
                    )} */}
